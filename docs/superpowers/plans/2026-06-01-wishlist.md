...
(Sem novas dependências — usa só libs nativas já presentes no app: `expo-image`, `expo-haptics`. Isso mantém a wishlist JS-only, sem necessidade de rebuild nativo.)

- [ ] **Step 1: Criar `app/wishlist/add.tsx`**
